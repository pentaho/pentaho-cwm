...
/**
 * ContactLocation association proxy interface. The ContactLocation association relates Contact instances to relevant
 * Location instances.
 * 
 * <p>
...
public interface ContactLocation extends javax.jmi.reflect.RefAssociation {
   ...
   */
  public boolean exists( org.pentaho.pms.cwm.pentaho.meta.businessinformation.CwmLocation location,
   ...
   *          Value of the second association end.
   */
  public boolean add( org.pentaho.pms.cwm.pentaho.meta.businessinformation.CwmLocation location,
      org.pentaho.pms.cwm.pentaho.meta.businessinformation.CwmContact contact );
   ...
   *          Value of the second association end.
   */
  public boolean remove( org.pentaho.pms.cwm.pentaho.meta.businessinformation.CwmLocation location,
      org.pentaho.pms.cwm.pentaho.meta.businessinformation.CwmContact contact );
}
