...
/**
 * EnumerationLiteral object instance interface. EnumerationLiteral instances describe the enumeration identifiers, and
 ...
 * </p>
 */
public interface CwmEnumerationLiteral extends org.pentaho.pms.cwm.pentaho.meta.core.CwmModelElement {
  /**
   * Returns the value of attribute value. The value associated with an enumeration identifier can be stored here. The
   * attribute is optional because enumeration literals are not required to have a specific, displayable value. This is
   * indicated by either an empty value attribute or a value attribute value whose expression body attribute is a
   * zero-length string.
   * 
   ...
   */
  public org.pentaho.pms.cwm.pentaho.meta.datatypes.CwmEnumeration getEnumeration();

  /**
   * Sets the value of reference enumeration. See {@link #getEnumeration} for description on the reference.
   * 
   * @param newValue
   *          New value to be set.
   */
  public void setEnumeration( org.pentaho.pms.cwm.pentaho.meta.datatypes.CwmEnumeration newValue );
}
