...
/**
 * Procedure class proxy interface. This class describes Relational DBMS Stored procedures and functions.
 * 
 * <p>
...
public interface CwmProcedureClass extends javax.jmi.reflect.RefClass {
   ...
   *          the CWM.
   * @param type
   *          A Procedure can be either a Function or a true Procedure. This indicates whether this object returns a
   *          value or not.
   * @return The created instance object.
   */
  public CwmProcedure createCwmProcedure( java.lang.String name,
      ...
      org.pentaho.pms.cwm.pentaho.meta.relational.enumerations.ProcedureType type );
}
