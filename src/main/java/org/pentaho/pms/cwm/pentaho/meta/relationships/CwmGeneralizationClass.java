...
/**
 * Generalization class proxy interface. A generalization is a taxonomic relationship between a more general element and
 * a more specific element. The more specific element is fully consistent with the more general element (it has all of
 * its properties, members, and relationships) and may contain additional information. In the metamodel, a
...
public interface CwmGeneralizationClass extends javax.jmi.reflect.RefClass {
   ...
   * @return The created instance object.
   */
  public CwmGeneralization createCwmGeneralization( java.lang.String name,
