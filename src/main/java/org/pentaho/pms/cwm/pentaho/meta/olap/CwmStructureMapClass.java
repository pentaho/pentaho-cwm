...
/**
 * StructureMap class proxy interface. StructureMap is a subclass of TransformationMap that maps Dimension attributes to
 * their physical data sources. (Note: Multiple StructureMaps may be grouped together into single, cohesive uni t via
 * TransformationTask.)
 * 
 * <p>
...
public interface CwmStructureMapClass extends javax.jmi.reflect.RefClass {
   ...
   * @return The created instance object.
   */
  public CwmStructureMap createCwmStructureMap( java.lang.String name,
