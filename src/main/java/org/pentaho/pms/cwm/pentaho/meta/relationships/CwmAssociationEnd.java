...
/**
 * AssociationEnd object instance interface. An association end is an endpoint of an association, which connects the
...
public interface CwmAssociationEnd extends org.pentaho.pms.cwm.pentaho.meta.core.CwmStructuralFeature {
  /**
   * Returns the value of attribute aggregation. When placed on one end (the "target" end), specifies whether the class
   * on the target end is an aggregation with respect to the class on the other end (the "source" end). Only one end of
   * an association can be an aggregation.
   * 
  ...
  /**
   * Sets the value of aggregation attribute. See {@link #getAggregation} for description on the attribute.
   * 
   * @param newValue
   *          New value to be set.
   */
  ...
  /**
   * Returns the value of attribute isNavigable. When placed on a target end, specifies whether traversal from a source
   * instance to its associated target instances is possible. A value of true means that the association can be
   * navigated by the source class and the target rolename can be used in navigation expressions. Specification of
  ...
  /**
   * Sets the value of isNavigable attribute. See {@link #isNavigable} for description on the attribute.
   * 
   * @param newValue
   *          New value to be set.
   */
