...
public final class ParameterDirectionKindEnum implements ParameterDirectionKind {
  ...
  public boolean equals( java.lang.Object o ) {
    if ( o instanceof ParameterDirectionKindEnum ) {
      return ( o == this );
    } else if ( o instanceof ParameterDirectionKind ) {
  ...
  public static ParameterDirectionKind forName( java.lang.String name ) {
    if ( name.equals( "pdk_in" ) ) {
      return PDK_IN;
    }
    if ( name.equals( "pdk_inout" ) ) {
      return PDK_INOUT;
    }
    if ( name.equals( "pdk_out" ) ) {
      return PDK_OUT;
    }
    if ( name.equals( "pdk_return" ) ) {
      return PDK_RETURN;
    }
    throw new java.lang.IllegalArgumentException( "Unknown literal name '" + name
        + "' for enumeration 'Pentaho.Meta.Behavioral.ParameterDirectionKind'" );
  }
