...
public final class ScopeKindEnum implements ScopeKind {
  ...
  public boolean equals( java.lang.Object o ) {
    if ( o instanceof ScopeKindEnum ) {
      return ( o == this );
    } else if ( o instanceof ScopeKind ) {
  ...
  public static ScopeKind forName( java.lang.String name ) {
    if ( name.equals( "sk_instance" ) ) {
      return SK_INSTANCE;
    }
    if ( name.equals( "sk_classifier" ) ) {
      return SK_CLASSIFIER;
    }
    throw new java.lang.IllegalArgumentException( "Unknown literal name '" + name
        + "' for enumeration 'Pentaho.Meta.Core.ScopeKind'" );
  }
