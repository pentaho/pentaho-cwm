...
/**
 * UniqueConstraint object instance interface. A condition to define uniqueness of rows in a table. An example of
 ...
 * </p>
 */
public interface CwmUniqueConstraint extends org.pentaho.pms.cwm.pentaho.meta.keysindexes.CwmUniqueKey {
  /**
   * Returns the value of attribute deferrability. Indicates if the validity of the UniqueConstraint is to be tested at
