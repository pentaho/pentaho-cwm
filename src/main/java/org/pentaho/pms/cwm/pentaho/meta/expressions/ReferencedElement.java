...
/**
 * ReferencedElement association proxy interface. The ReferencedElement association links the ElementNode instances of
 * an expression with the ModelElement instances to which they refer.
 * 
 * <p>
...
public interface ReferencedElement extends javax.jmi.reflect.RefAssociation {
  ...
  public boolean exists( org.pentaho.pms.cwm.pentaho.meta.core.CwmModelElement modelElement,
      org.pentaho.pms.cwm.pentaho.meta.expressions.CwmElementNode elementNode );
