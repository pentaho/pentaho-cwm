...
public final class AggregationKindEnum implements AggregationKind {
  ...
  public boolean equals( java.lang.Object o ) {
    if ( o instanceof AggregationKindEnum ) {
      return ( o == this );
    } else if ( o instanceof AggregationKind ) {
  ...
  public static AggregationKind forName( java.lang.String name ) {
    if ( name.equals( "ak_none" ) ) {
      return AK_NONE;
    }
    if ( name.equals( "ak_aggregate" ) ) {
      return AK_AGGREGATE;
    }
    if ( name.equals( "ak_composite" ) ) {
      return AK_COMPOSITE;
    }
    throw new java.lang.IllegalArgumentException( "Unknown literal name '" + name
        + "' for enumeration 'Pentaho.Meta.Relationships.AggregationKind'" );
  }
