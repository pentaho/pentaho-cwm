...
/**
 * Union object instance interface. The Union class represents programming language unions and similarly structured data
...
public interface CwmUnion extends org.pentaho.pms.cwm.pentaho.meta.core.CwmClassifier {
  ...
  /**
   * Sets the value of reference discriminator. See {@link #getDiscriminator} for description on the reference.
   * 
   * @param newValue
   *          New value to be set.
   */
