 ...
 * </p>
 */
public final class DeferrabilityTypeEnum implements DeferrabilityType {
  /**
  ...
  public boolean equals( java.lang.Object o ) {
    if ( o instanceof DeferrabilityTypeEnum ) {
      return ( o == this );
    } else if ( o instanceof DeferrabilityType ) {
   ...
   */
  public static DeferrabilityType forName( java.lang.String name ) {
    if ( name.equals( "initiallyDeferred" ) ) {
      return INITIALLY_DEFERRED;
    }
    if ( name.equals( "initiallyImmediate" ) ) {
      return INITIALLY_IMMEDIATE;
    }
    if ( name.equals( "notDeferrable" ) ) {
      return NOT_DEFERRABLE;
    }
    throw new java.lang.IllegalArgumentException( "Unknown literal name '" + name
        + "' for enumeration 'Pentaho.Meta.Relational.Enumerations.DeferrabilityType'" );
  }
