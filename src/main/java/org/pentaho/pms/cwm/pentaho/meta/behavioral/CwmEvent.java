...
/**
 * Event object instance interface. Event is a specification of an observable occurrence. The occurrence that generates
 * an event instance is assumed to take place at an instant in time.
 * 
 * <p>
