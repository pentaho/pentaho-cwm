...
/**
 * TaggedElement association proxy interface. The TaggedElement association links TaggedValues with the ModelElements
 * that own them. TaggedValues cannot simultaneously participate in both the TaggedElement and StereotypeTaggedValues
 * associations.
 * 
 * <p>
...
public interface TaggedElement extends javax.jmi.reflect.RefAssociation {
  ...
  public boolean exists( org.pentaho.pms.cwm.pentaho.meta.core.CwmModelElement modelElement,
      org.pentaho.pms.cwm.pentaho.meta.core.CwmTaggedValue taggedValue );
