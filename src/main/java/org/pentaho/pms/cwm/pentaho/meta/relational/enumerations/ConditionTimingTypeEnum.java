...
public final class ConditionTimingTypeEnum implements ConditionTimingType {
  ...
  public boolean equals( java.lang.Object o ) {
    if ( o instanceof ConditionTimingTypeEnum ) {
      return ( o == this );
    } else if ( o instanceof ConditionTimingType ) {
  ...
  public static ConditionTimingType forName( java.lang.String name ) {
    ...
    throw new java.lang.IllegalArgumentException( "Unknown literal name '" + name
        + "' for enumeration 'Pentaho.Meta.Relational.Enumerations.ConditionTimingType'" );
  }
