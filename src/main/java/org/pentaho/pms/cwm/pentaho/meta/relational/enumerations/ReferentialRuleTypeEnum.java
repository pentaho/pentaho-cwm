...
public final class ReferentialRuleTypeEnum implements ReferentialRuleType {
   ...
   */
  public static final ReferentialRuleTypeEnum IMPORTED_KEY_NO_ACTION = new ReferentialRuleTypeEnum(
      "importedKeyNoAction" );
  /**
  ...
  public static final ReferentialRuleTypeEnum IMPORTED_KEY_SET_NULL =
      new ReferentialRuleTypeEnum( "importedKeySetNull" );
  /**
   * Enumeration constant corresponding to literal importedKeyRestrict.
   */
  public static final ReferentialRuleTypeEnum IMPORTED_KEY_RESTRICT = new ReferentialRuleTypeEnum(
      "importedKeyRestrict" );
  /**
   * Enumeration constant corresponding to literal importedKeySetDefault.
   */
  public static final ReferentialRuleTypeEnum IMPORTED_KEY_SET_DEFAULT = new ReferentialRuleTypeEnum(
  ...
  public boolean equals( java.lang.Object o ) {
    if ( o instanceof ReferentialRuleTypeEnum ) {
      return ( o == this );
    } else if ( o instanceof ReferentialRuleType ) {
  ...
  public static ReferentialRuleType forName( java.lang.String name ) {
    if ( name.equals( "importedKeyNoAction" ) ) {
      return IMPORTED_KEY_NO_ACTION;
    }
    if ( name.equals( "importedKeyCascade" ) ) {
      return IMPORTED_KEY_CASCADE;
    }
    if ( name.equals( "importedKeySetNull" ) ) {
      return IMPORTED_KEY_SET_NULL;
    }
    if ( name.equals( "importedKeyRestrict" ) ) {
      return IMPORTED_KEY_RESTRICT;
    }
    if ( name.equals( "importedKeySetDefault" ) ) {
      return IMPORTED_KEY_SET_DEFAULT;
    }
    throw new java.lang.IllegalArgumentException( "Unknown literal name '" + name
        + "' for enumeration 'Pentaho.Meta.Relational.Enumerations.ReferentialRuleType'" );
  }
