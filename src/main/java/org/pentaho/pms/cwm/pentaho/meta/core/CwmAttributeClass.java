...
/**
 * Attribute class proxy interface. An Attribute describes a named slot within a classifier that may hold a value.
 * 
 * <p>
...
public interface CwmAttributeClass extends javax.jmi.reflect.RefClass {
   ...
   * @return The created instance object.
   */
  public CwmAttribute createCwmAttribute( java.lang.String name,
