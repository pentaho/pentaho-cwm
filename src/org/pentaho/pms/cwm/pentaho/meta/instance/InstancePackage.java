 ...
 * In addition to the metadata normally interchanged with CWM, it is sometimes useful to interchan
 * ge specific data instances as well. The ObjectModel?s Instance metamodel all
 * ows the inclusion of data instances with the metadata.
 ...
 *    cnt
 * end if ) > 1
 * [C-6-5] If the StructuralFeature describing a Slot is an AssociationEnd, the Classifier associa
 * ted with the Object owning the Slot must be an Association.
 * context Slot inv:
