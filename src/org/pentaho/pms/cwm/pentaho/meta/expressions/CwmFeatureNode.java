...
/**
 * FeatureNode object instance interface.
 * The FeatureNode class represents ExpressionNode instances that are features 
 * (i.e., attributes or operations) of some Classifier instance within the 
 * CWM.
 * A FeatureNode with a null OperationArgument association represents either a 
 * parameter-less operation or an attribute value obtained from some Struct
 * uralFeature instance.
 *  
...
public interface CwmFeatureNode extends org.pentaho.pms.cwm.pentaho.meta.expressions.CwmExpressionNode {
     ...
     * @return Value of reference argument. Element type: {@link org.pentaho.pms.cwm.pentaho.meta.expressions.CwmExpressionNode}
     */
