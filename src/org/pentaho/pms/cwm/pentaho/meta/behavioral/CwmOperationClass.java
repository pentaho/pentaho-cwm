 ...
 * An Operation has a signature, which describes the parameters that are possible 
 * (including possible return values).
 * In the metamodel, an Operation is a BehavioralFeature that can be applied to ins
 * tances of the Classifier that contains the Operation.
...
public interface CwmOperationClass extends javax.jmi.reflect.RefClass {
     ...
     * @param isAbstract If true, then the Operation does not have an implementation, 
     * and one must be supplied by a descendant. If false, the Operation must 
     * have an implementation in the class or inherited from an ancestor.
     * @return The created instance object.
     */
    public CwmOperation createCwmOperation(java.lang.String name, org.pentaho.pms.cwm.pentaho.meta.core.VisibilityKind visibility, org.pentaho.pms.cwm.pentaho.meta.core.ScopeKind ownerScope, boolean isQuery, boolean isAbstract);
}
