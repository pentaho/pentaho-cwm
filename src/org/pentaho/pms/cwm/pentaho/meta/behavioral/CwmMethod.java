...
public interface CwmMethod extends org.pentaho.pms.cwm.pentaho.meta.behavioral.CwmBehavioralFeature {
     ...
     * A specification of the Method in some appropriate form (such as a programming 
     * language). The exact form of a Method?s specification and knowledge of 
     * the language in which it is described is outside the scope of the CWM.
