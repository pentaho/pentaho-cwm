 ...
 * some other Class, and the Index is said to "span" the Class. Indexes normally 
 * have an ordered set of attributes of the Class instance they span that 
 * make up the "key" of the index; this set of relationships is represented 
 * by the IndexedFeature class that indicates how the attributes are used 
 * by the Index instance.
...
public interface CwmIndex extends org.pentaho.pms.cwm.pentaho.meta.core.CwmModelElement {
    ...
    /**
     * Sets the value of isPartitioning attribute. See {@link #isPartitioning} 
    ...
    /**
     * Sets the value of isSorted attribute. See {@link #isSorted} for description 
     * on the attribute.
     * @param newValue New value to be set.
     */
     ...
     * The isUnique attribute is True if the Index instance guarantees all of 
     * its instances have a unique key value.
     * @return Value of attribute isUnique.
     */
    public boolean isUnique();
    /**
     * Sets the value of isUnique attribute. See {@link #isUnique} for description 
     * on the attribute.
     * @param newValue New value to be set.
     */
     ...
     * @return Value of reference indexedFeature. Element type: {@link org.pentaho.pms.cwm.pentaho.meta.keysindexes.CwmIndexedFeature}
     */
    ...
    /**
     * Sets the value of reference spannedClass. See {@link #getSpannedClass} 
