...
/**
 * Telephone object instance interface.
...
public interface CwmTelephone extends org.pentaho.pms.cwm.pentaho.meta.core.CwmModelElement {
    ...
    /**
     * Sets the value of phoneNumber attribute. See {@link #getPhoneNumber} for 
     ...
     * A textual representation of the telephone?s type, such as "multi-line", 
     * or its usage,
    ...
    /**
     * Sets the value of phoneType attribute. See {@link #getPhoneType} for description 
     * on the attribute.
     * @param newValue New value to be set.
     */
