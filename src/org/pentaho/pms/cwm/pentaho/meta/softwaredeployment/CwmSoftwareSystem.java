...
/**
 * SoftwareSystem object instance interface.
...
public interface CwmSoftwareSystem extends org.pentaho.pms.cwm.pentaho.meta.core.CwmSubsystem {
     ...
     * For some of the predefined types, suggested subtype values are listed belo
     * w:
    ...
    /**
     * Sets the value of subtype attribute. See {@link #getSubtype} for description 
     * on the attribute.
     * @param newValue New value to be set.
     */
    ...
    /**
     * Sets the value of supplier attribute. See {@link #getSupplier} for description 
     * on the attribute.
     * @param newValue New value to be set.
     */
     ...
     * @return Value of reference typespace. Element type: {@link org.pentaho.pms.cwm.pentaho.meta.typemapping.CwmTypeSystem}
     */
