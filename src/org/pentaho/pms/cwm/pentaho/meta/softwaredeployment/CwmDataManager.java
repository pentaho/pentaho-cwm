...
/**
 * DataManager object instance interface.
...
public interface CwmDataManager extends org.pentaho.pms.cwm.pentaho.meta.softwaredeployment.CwmDeployedComponent {
    /**
     * Returns the value of attribute isCaseSensitive.
     * Indicates whether or not the DataManager treats lower case letters within 
     * object names as being different from the corresponding upper case letters.
     * @return Value of attribute isCaseSensitive.
     */
    public boolean isCaseSensitive();
    /**
     * Sets the value of isCaseSensitive attribute. See {@link #isCaseSensitive} 
