...
/**
 * DeployedSoftwareSystem object instance interface.
 * A DeployedSoftwareSystem represents a deployment of a SoftwareSystem.
 * Its associated DeployedComponents identify the individual Component dep
 * loyments that constitute the DeployedSoftwareSystem. These DeployedComponents ar
 * e not necessarily all deployed on the same Machine.
 *  
...
public interface CwmDeployedSoftwareSystem extends org.pentaho.pms.cwm.pentaho.meta.core.CwmPackage {
    /**
     * Returns the value of attribute fixLevel.
    ...
    /**
     * Sets the value of fixLevel attribute. See {@link #getFixLevel} for description 
     * on the attribute.
    ...
    /**
     * Sets the value of reference softwareSystem. See {@link #getSoftwareSystem} 
