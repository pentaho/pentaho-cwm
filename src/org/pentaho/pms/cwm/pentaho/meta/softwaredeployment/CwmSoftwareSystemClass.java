...
/**
 * SoftwareSystem class proxy interface.
...
public interface CwmSoftwareSystemClass extends javax.jmi.reflect.RefClass {
     ...
     * @param type Identifies the type of the software product. One of the following 
     * predefined values should be used if appropriate:
     *     OS, DBMS, MDDB, FileSystem, ODBC, JDBC or Application.
     * @param subtype This is used in conjunction with the type attribute to provide 
     * additional information about the type of the software product.
     ...
     *       Essbase or Express.
     * @param supplier The supplier of the software product.
     * @param version The version identification for the software product.
     * @return The created instance object.
     */
    public CwmSoftwareSystem createCwmSoftwareSystem(java.lang.String name, org.pentaho.pms.cwm.pentaho.meta.core.VisibilityKind visibility, boolean isAbstract, java.lang.String type, java.lang.String subtype, java.lang.String supplier, java.lang.String version);
}
