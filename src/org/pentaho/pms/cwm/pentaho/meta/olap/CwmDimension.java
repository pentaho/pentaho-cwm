...
/**
 * Dimension object instance interface.
 * A Dimension is an ordinate within a multidimensional structure, and consists 
 * of an ordered list of values (i.e.,  members) that share a common semantic 
 * meaning within the domain being modeled.  Each member designates a unique 
 * position along its ordinate.
 * Typical Dimensions are: Time, Product, Geography, Scenario (e.g., actual, bud
 * get, forecast), Measure (e.g., sales, quantity).
 *  
...
public interface CwmDimension extends org.pentaho.pms.cwm.pentaho.meta.core.CwmClass {
    /**
     * Returns the value of attribute isTime.
     * If true, then this Dimension is a Time Dimension (i.e., its members collectively 
     * represent a time series).
     * @return Value of attribute isTime.
     */
    public boolean isTime();
    /**
     * Sets the value of isTime attribute. See {@link #isTime} for description 
     * on the attribute.
     * @param newValue New value to be set.
     */
    public void setTime(boolean newValue);
    /**
     * Returns the value of attribute isMeasure.
    ...
    /**
     * Sets the value of isMeasure attribute. See {@link #isMeasure} for description 
     * on the attribute.
     * @param newValue New value to be set.
     */
     ...
     * @return Value of reference cubeDimensionAssociation. Element type: {@link 
     * org.pentaho.pms.cwm.pentaho.meta.olap.CwmCubeDimensionAssociation}
     */
    public java.util.Collection/*<org.pentaho.pms.cwm.pentaho.meta.olap.CwmCubeDimensionAssociation>*/ getCubeDimensionAssociation();
    /**
    ...
    /**
     * Sets the value of reference displayDefault. See {@link #getDisplayDefault} 
