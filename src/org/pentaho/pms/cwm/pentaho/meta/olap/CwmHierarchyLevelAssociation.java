...
/**
 * HierarchyLevelAssociation object instance interface.
...
public interface CwmHierarchyLevelAssociation extends org.pentaho.pms.cwm.pentaho.meta.core.CwmClass {
    ...
    /**
     * Sets the value of reference levelBasedHierarchy. See {@link #getLevelBasedHierarchy} 
    ...
    /**
     * Sets the value of reference currentLevel. See {@link #getCurrentLevel} 
     * for description on the reference.
     * @param newValue New value to be set.
     */
