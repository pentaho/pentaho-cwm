...
/**
 * StructureMap object instance interface.
...
public interface CwmStructureMap extends org.pentaho.pms.cwm.pentaho.meta.transformation.CwmTransformationMap {
    ...
    /**
     * Sets the value of reference dimensionDeployment. See {@link #getDimensionDeployment} 
    ...
    /**
     * Sets the value of reference dimensionDeploymentLV. See {@link #getDimensionDeploymentLv} 
     * for description on the reference.
     * @param newValue New value to be set.
     */
    ...
    /**
     * Sets the value of reference dimensionDeploymentIP. See {@link #getDimensionDeploymentIp} 
     * for description on the reference.
     * @param newValue New value to be set.
     */
