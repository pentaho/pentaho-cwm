...
/**
 * CubeRegion object instance interface.
 ...
 * When mapped to its physical source, a CubeRegion contains data cells iden
 * tified by the member combinations of the Cartesian product of the CubeRegion's 
 * associated Dimensions and Measures.
 * The relative ordering of CubeDeployment classes optionally implies a desi
 * red order of selection of the CubeDeployments, based on implementation-specific
 ...
 * 4.  If a Cube does not have a CubeRegion, then it's not physically mapped
 *  (it's virtual).  All physical mapping is based on the CubeRegion , not the Cub
 * e.
 *  
...
public interface CwmCubeRegion extends org.pentaho.pms.cwm.pentaho.meta.core.CwmClass {
     ...
     * If true, then the CubeRegion content is read-only (i.e., may not be written 
    ...
    /**
     * Sets the value of isReadOnly attribute. See {@link #isReadOnly} for description 
     * on the attribute.
     * @param newValue New value to be set.
     */
    public void setReadOnly(boolean newValue);
    /**
     * Returns the value of attribute isFullyRealized.
     * If true, then this CubeRegion has a direct physical realization and is 
     * not bound by any MemberSelections.
     * @return Value of attribute isFullyRealized.
     */
    public boolean isFullyRealized();
    /**
     * Sets the value of isFullyRealized attribute. See {@link #isFullyRealized} 
     ...
     * @return Value of reference memberSelectionGroup. Element type: {@link org.pentaho.pms.cwm.pentaho.meta.olap.CwmMemberSelectionGroup}
     */
