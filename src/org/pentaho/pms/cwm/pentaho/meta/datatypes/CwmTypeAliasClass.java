 ...
 * The TypeAlias class is intended to provide a renaming capability for Classifier 
 * instances. This class is required to support situations in which creation 
 * of an alias for a class effectively creates a new class. For example, CORBA 
 * IDL type aliases have different typeCodes than their base types and are 
...
public interface CwmTypeAliasClass extends javax.jmi.reflect.RefClass {
     ...
     * @return The created instance object.
     */
    public CwmTypeAlias createCwmTypeAlias(java.lang.String name, org.pentaho.pms.cwm.pentaho.meta.core.VisibilityKind visibility, boolean isAbstract);
}
