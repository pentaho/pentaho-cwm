...
public interface CwmEnumerationLiteralClass extends javax.jmi.reflect.RefClass {
     ...
     * @param value The value associated with an enumeration identifier can be 
     * stored here. The attribute is optional because enumeration literals are 
     * not required to have a specific, displayable value. This is indicated by 
     * either an empty value attribute or a value attribute value whose expression 
     * body attribute is a zero-length string.
     * @return The created instance object.
     */
    public CwmEnumerationLiteral createCwmEnumerationLiteral(java.lang.String name, org.pentaho.pms.cwm.pentaho.meta.core.VisibilityKind visibility, org.pentaho.pms.cwm.pentaho.meta.core.CwmExpression value);
}
