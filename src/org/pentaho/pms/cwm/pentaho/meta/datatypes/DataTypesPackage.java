 ...
 * The CWM DataTypes metamodel supports definition of metamodel constructs that modelers can use t
 * o create the specific data types they need. Although the CWM Foundation 
 * itself does not contain specific data type definitions, a number of data typ
 * e definitions for widely used environments are provided (in the CWM Data Ty
 * pes chapter) as examples of the appropriate usage of CWM Foundation classes 
 * for creating
