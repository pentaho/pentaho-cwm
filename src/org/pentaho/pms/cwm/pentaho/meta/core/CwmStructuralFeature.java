...
public interface CwmStructuralFeature extends org.pentaho.pms.cwm.pentaho.meta.core.CwmFeature {
     ...
     * The possible number of data values for the feature that may be held by 
     * an instance. The cardinality of the set of values is an implicit part of 
     * the feature. In the common case in which the multiplicity is 1..1, then 
     * the feature is a scalar (i.e., it holds exactly one value).
