...
public interface CwmMultiplicityRangeClass extends javax.jmi.reflect.RefClass {
     ...
     * values.
     * @param lower Specifies the positive integer lower bound of the range.
     * @param upper Specifies the upper bound of the range, which is a positive 
     * integer or the special value ?unlimited? indicating no upper bound is defined.
     * @return The created instance object.
     */
