 ...
 *  Values and Constraints attached to a Stereotype apply to all ModelElem
 * ents branded by that Stereotype.
 * A stereotype keeps track of the base class to which it may be applied. The base
 *  class is a class in the metamodel (not a user-level modeling element) 
 * such as Class, Association, etc. If a model element is branded by an attached stereo
 * type, then the CWM base class of the model element must be the base clas
 * s specified by the stereotype or one of the subclasses of that base class.
 *  
...
public interface CwmStereotypeClass extends javax.jmi.reflect.RefClass {
     ...
     * @param baseClass Specifies the name of a modeling element to which the 
     * stereotype applies, such as Class, Association, Constraint, etc. This is 
     * the name of a metaclass, that is, a class from the metamodel itself rather 
     * than a user model class.
     * @return The created instance object.
     */
    public CwmStereotype createCwmStereotype(java.lang.String name, org.pentaho.pms.cwm.pentaho.meta.core.VisibilityKind visibility, java.lang.String baseClass);
}
