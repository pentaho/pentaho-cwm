...
public interface CwmForeignKey extends org.pentaho.pms.cwm.pentaho.meta.keysindexes.CwmKeyRelationship {
     ...
     * An enumerated type. Indicates the disposition of the data records containing 
     * the foreign key value when the record of the matching primary key is deleted.
    ...
    /**
     * Sets the value of deleteRule attribute. See {@link #getDeleteRule} for 
    ...
    /**
     * Sets the value of updateRule attribute. See {@link #getUpdateRule} for 
     * description on the attribute.
     * @param newValue New value to be set.
     */
     ...
     * Indicates if the validity of the ForeignKey is to be tested at each statement 
    ...
    /**
     * Sets the value of deferrability attribute. See {@link #getDeferrability} 
