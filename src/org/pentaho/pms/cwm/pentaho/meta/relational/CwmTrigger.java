...
public interface CwmTrigger extends org.pentaho.pms.cwm.pentaho.meta.core.CwmModelElement {
    ...
    /**
     * Sets the value of eventManipulation attribute. See {@link #getEventManipulation} 
     * for description on the attribute.
     * @param newValue New value to be set.
     */
    public void setEventManipulation(org.pentaho.pms.cwm.pentaho.meta.relational.enumerations.EventManipulationType newValue);
    /**
    ...
    /**
     * Sets the value of actionCondition attribute. See {@link #getActionCondition} 
     * for description on the attribute.
     * @param newValue New value to be set.
     */
    ...
    /**
     * Sets the value of actionStatement attribute. See {@link #getActionStatement} 
     * for description on the attribute.
     * @param newValue New value to be set.
     */
     ...
     * It indicates if the trigger is called once per statement execution or before 
     * or after each row of the table is modified.
    ...
    /**
     * Sets the value of actionOrientation attribute. See {@link #getActionOrientation} 
     * for description on the attribute.
     * @param newValue New value to be set.
     */
    public void setActionOrientation(org.pentaho.pms.cwm.pentaho.meta.relational.enumerations.ActionOrientationType newValue);
    /**
     * Returns the value of attribute conditionTiming.
     * It indicates if the trigger activity is run before or after the statement 
     * or row is modified.
    ...
    /**
     * Sets the value of conditionTiming attribute. See {@link #getConditionTiming} 
     * for description on the attribute.
     * @param newValue New value to be set.
     */
    public void setConditionTiming(org.pentaho.pms.cwm.pentaho.meta.relational.enumerations.ConditionTimingType newValue);
    /**
    ...
    /**
     * Sets the value of conditionReferenceNewTable attribute. See {@link #getConditionReferenceNewTable} 
     * for description on the attribute.
     * @param newValue New value to be set.
     */
     ...
     * The alias for the name of the owning table, used in the actionStatement, 
     * to represent the state of the table before the update/delete/insert.
     * @return Value of attribute conditionReferenceOldTable.
     */
    public java.lang.String getConditionReferenceOldTable();
    /**
     * Sets the value of conditionReferenceOldTable attribute. See {@link #getConditionReferenceOldTable} 
     * for description on the attribute.
     * @param newValue New value to be set.
     */
    ...
    /**
     * Sets the value of reference table. See {@link #getTable} for description 
     * on the reference.
     * @param newValue New value to be set.
     */
     ...
     * @return Value of reference usedColumnSet. Element type: {@link org.pentaho.pms.cwm.pentaho.meta.relational.CwmNamedColumnSet}
     */
