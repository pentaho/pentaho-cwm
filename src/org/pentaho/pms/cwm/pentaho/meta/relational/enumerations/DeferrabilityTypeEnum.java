...
public final class DeferrabilityTypeEnum implements DeferrabilityType {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        else if (o instanceof DeferrabilityType) return (o.toString().equals(literalName));
    ...
    public static DeferrabilityType forName(java.lang.String name) {
        ...
        throw new java.lang.IllegalArgumentException("Unknown literal name '" + name + "' for enumeration 'Pentaho.Meta.Relational.Enumerations.DeferrabilityType'");
    }
    /**
