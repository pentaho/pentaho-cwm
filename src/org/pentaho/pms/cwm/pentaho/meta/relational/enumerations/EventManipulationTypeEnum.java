...
public final class EventManipulationTypeEnum implements EventManipulationType {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        else if (o instanceof EventManipulationType) return (o.toString().equals(literalName));
    ...
    public static EventManipulationType forName(java.lang.String name) {
        ...
        throw new java.lang.IllegalArgumentException("Unknown literal name '" + name + "' for enumeration 'Pentaho.Meta.Relational.Enumerations.EventManipulationType'");
    }
    /**
