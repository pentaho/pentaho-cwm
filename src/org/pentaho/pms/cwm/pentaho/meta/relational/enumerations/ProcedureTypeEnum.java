 ...
 */
public final class ProcedureTypeEnum implements ProcedureType {
    /**
    ...
    public boolean equals(java.lang.Object o) {
        ...
        else if (o instanceof ProcedureType) return (o.toString().equals(literalName));
     ...
     */
    public static ProcedureType forName(java.lang.String name) {
        if (name.equals("procedure")) return PROCEDURE;
        if (name.equals("function")) return FUNCTION;
        throw new java.lang.IllegalArgumentException("Unknown literal name '" + name + "' for enumeration 'Pentaho.Meta.Relational.Enumerations.ProcedureType'");
    }
    /**
