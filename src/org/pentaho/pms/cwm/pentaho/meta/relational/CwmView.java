...
public interface CwmView extends org.pentaho.pms.cwm.pentaho.meta.relational.CwmNamedColumnSet {
     ...
     * indicates that the RDBMS will validate that changes made to the data verify 
     * the view filtering condition and belong to the view result set.
     * @return Value of attribute checkOption.
     */
    public boolean isCheckOption();
    /**
     * Sets the value of checkOption attribute. See {@link #isCheckOption} for 
    ...
    /**
     * Sets the value of queryExpression attribute. See {@link #getQueryExpression} 
