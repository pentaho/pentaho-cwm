...
public interface CwmColumn extends org.pentaho.pms.cwm.pentaho.meta.core.CwmAttribute {
    ...
    /**
     * Sets the value of precision attribute. See {@link #getPrecision} for description 
     * on the attribute.
    ...
    /**
     * Sets the value of scale attribute. See {@link #getScale} for description 
     * on the attribute.
     * @param newValue New value to be set.
     */
    ...
    /**
     * Sets the value of isNullable attribute. See {@link #getIsNullable} for 
     ...
     * The length of fixed length character or byte strings. Maximum length if 
     * length is variable.
     * @return Value of attribute length.
     */
    public java.lang.Integer getLength();
    /**
     * Sets the value of length attribute. See {@link #getLength} for description 
     * on the attribute.
     * @param newValue New value to be set.
     */
     ...
     * column.
     * This applies only to columns whose datatype is a form of character stri
     * ng.
     * @return Value of attribute collationName.
     */
    public java.lang.String getCollationName();
    /**
     * Sets the value of collationName attribute. See {@link #getCollationName} 
    ...
    /**
     * Sets the value of characterSetName attribute. See {@link #getCharacterSetName} 
     * for description on the attribute.
     * @param newValue New value to be set.
     */
    ...
    /**
     * Sets the value of reference optionScopeColumnSet. See {@link #getOptionScopeColumnSet} 
    ...
    /**
     * Sets the value of reference referencedTableType. See {@link #getReferencedTableType} 
     * for description on the reference.
     * @param newValue New value to be set.
     */
