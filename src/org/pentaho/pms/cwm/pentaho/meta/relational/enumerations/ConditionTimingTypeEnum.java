...
public final class ConditionTimingTypeEnum implements ConditionTimingType {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        else if (o instanceof ConditionTimingType) return (o.toString().equals(literalName));
     ...
     */
    public static ConditionTimingType forName(java.lang.String name) {
        if (name.equals("before")) return BEFORE;
        if (name.equals("after")) return AFTER;
        throw new java.lang.IllegalArgumentException("Unknown literal name '" + name + "' for enumeration 'Pentaho.Meta.Relational.Enumerations.ConditionTimingType'");
    }
    /**
