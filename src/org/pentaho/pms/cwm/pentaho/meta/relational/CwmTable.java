...
public interface CwmTable extends org.pentaho.pms.cwm.pentaho.meta.relational.CwmNamedColumnSet {
     ...
     * two types of temporary tables (local Temporary and Global Temporary). However, 
    ...
    /**
     * Sets the value of isTemporary attribute. See {@link #isTemporary} for description 
     * on the attribute.
     ...
     * The scope indicates when the data of this table are available. "SESSION", 
     * "APPLICATION" are examples of possible values. Look at the Scope attribute 
     * for Global Temporary tables in the SQL standards for more details.
     * @return Value of attribute temporaryScope.
     */
    public java.lang.String getTemporaryScope();
    /**
     * Sets the value of temporaryScope attribute. See {@link #getTemporaryScope} 
     ...
     * Indicates that the Table is a System Table (generally part of or view on 
     * the system catalog).
     * @return Value of attribute isSystem.
     */
    public boolean isSystem();
    /**
     * Sets the value of isSystem attribute. See {@link #isSystem} for description 
     * on the attribute.
     * @param newValue New value to be set.
     */
