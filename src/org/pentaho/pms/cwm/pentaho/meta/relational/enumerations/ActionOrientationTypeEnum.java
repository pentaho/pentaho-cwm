...
public final class ActionOrientationTypeEnum implements ActionOrientationType {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        else if (o instanceof ActionOrientationType) return (o.toString().equals(literalName));
    ...
    public static ActionOrientationType forName(java.lang.String name) {
        ...
        throw new java.lang.IllegalArgumentException("Unknown literal name '" + name + "' for enumeration 'Pentaho.Meta.Relational.Enumerations.ActionOrientationType'");
    }
    /**
