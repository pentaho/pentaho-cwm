 ...
 */
public interface CwmSqlsimpleType extends org.pentaho.pms.cwm.pentaho.meta.relational.CwmSqldataType, org.pentaho.pms.cwm.pentaho.meta.core.CwmDataType {
    /**
    ...
    /**
     * Sets the value of characterMaximumLength attribute. See {@link #getCharacterMaximumLength} 
    ...
    /**
     * Sets the value of characterOctetLength attribute. See {@link #getCharacterOctetLength} 
     * for description on the attribute.
     * @param newValue New value to be set.
     */
    ...
    /**
     * Sets the value of numericPrecision attribute. See {@link #getNumericPrecision} 
     * for description on the attribute.
     * @param newValue New value to be set.
     */
    ...
    /**
     * Sets the value of numericPrecisionRadix attribute. See {@link #getNumericPrecisionRadix} 
     * for description on the attribute.
     * @param newValue New value to be set.
     */
    ...
    /**
     * Sets the value of numericScale attribute. See {@link #getNumericScale} 
     * for description on the attribute.
     * @param newValue New value to be set.
     */
    ...
    /**
     * Sets the value of dateTimePrecision attribute. See {@link #getDateTimePrecision} 
     * for description on the attribute.
     * @param newValue New value to be set.
     */
