 ...
 * Dimension represents physical dimension in a multidimensional database 
 * (e.g., a dimension object defined by the programming model/API of an OLAP 
 * database server). Tool-specific extensions to the Multidimensional package 
 * will generally contain classes that derive from Dimension.
 *  
...
public interface CwmDimension extends org.pentaho.pms.cwm.pentaho.meta.core.CwmClass {
     ...
     */
    public java.util.List/*<org.pentaho.pms.cwm.pentaho.meta.multidimensional.CwmDimensionedObject>*/ getDimensionedObject();
    /**
     * Returns the value of reference component.
     * @return Value of reference component. Element type: {@link org.pentaho.pms.cwm.pentaho.meta.multidimensional.CwmDimension}
     */
     ...
     * @return Value of reference composite. Element type: {@link org.pentaho.pms.cwm.pentaho.meta.multidimensional.CwmDimension}
     */
     ...
     * @return Value of reference memberSet. Element type: {@link org.pentaho.pms.cwm.pentaho.meta.multidimensional.CwmMemberSet}
     */
