...
/**
 * TransformationTree class proxy interface.
...
public interface CwmTransformationTreeClass extends javax.jmi.reflect.RefClass {
     ...
     * @param type Identifies the type of TransformationTree, which can be unary 
     * or binary.
     * @param body Identifies the expression tree that embodies the TransformationTree.
     * @return The created instance object.
     */
    public CwmTransformationTree createCwmTransformationTree(java.lang.String name, org.pentaho.pms.cwm.pentaho.meta.core.VisibilityKind visibility, org.pentaho.pms.cwm.pentaho.meta.core.CwmProcedureExpression function, java.lang.String functionDescription, boolean isPrimary, org.pentaho.pms.cwm.pentaho.meta.transformation.TreeType type, org.pentaho.pms.cwm.pentaho.meta.expressions.CwmExpressionNode body);
}
