...
/**
 * ClassifierFeatureMap class proxy interface.
...
public interface CwmClassifierFeatureMapClass extends javax.jmi.reflect.RefClass {
     ...
     * @param function Any code or script for the FeatureMap.
     * @param functionDescription A short description for any code or script performed 
     * by the FeatureMap.
     * @param classifierToFeature Identifies if the mapping is from Classifiers 
     * (source) to Features (target). The default is true.
     * @return The created instance object.
     */
    public CwmClassifierFeatureMap createCwmClassifierFeatureMap(java.lang.String name, org.pentaho.pms.cwm.pentaho.meta.core.VisibilityKind visibility, org.pentaho.pms.cwm.pentaho.meta.core.CwmProcedureExpression function, java.lang.String functionDescription, boolean classifierToFeature);
}
