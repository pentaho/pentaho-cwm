...
/**
 * TypeMapping package interface.
 * The TypeMapping package depends on the following packages:
 *     org.omg::CWM::ObjectModel::Core
 * The TypeMapping package supports the mapping of data types between different systems. The purpose
 *  of these mappings is to indicate data types in different systems that are su
 * fficiently compatible that data values can be interchanged between them. Multi
 * ple mappings are allowed between any pair of types and a means of identifying 
